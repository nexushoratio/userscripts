...
window.NexusHoratio.widget = (function widget() {
   ...
   *
   * @todo [(#375)](https://github.com/nexushoratio/userscripts/issues/375)
   * The historical symbols for identifying panels are now deprecated and
   * should be replaced with their {@link NexusHoratio.widget.Layout.Panel
  ...
  /** @deprecated */
  Layout.BOTTOM = Layout.Panel.BOTTOM;

  /** @deprecated */
  Layout.LEFT = Layout.Panel.LEFT;

  /** @deprecated */
  Layout.MAIN = Layout.Panel.MAIN;

  /** @deprecated */
  Layout.RIGHT = Layout.Panel.RIGHT;

  /** @deprecated */
  Layout.TOP = Layout.Panel.TOP;
