...
window.NexusHoratio.widget = (function widget() {
  ...
  class GridColumn {
    ...
    constructor(field) {
      if (!field) {
        throw new WidgetError('A "field" is required');
      }
      this.#field = field;
  ...
  class GridTestCase extends NH.xunit.TestCase {
    ...
    testBuildWithData() {
      ...
      const expected = [
        ...
        '<td class="id"><content id="ElementAdapter-id-.*-container">',
        '<span>1</span>',
        '</content></td>',
        ...
        '<td class="typ"><content id="StringAdapter-typ-.*-container">',
        'juvenile, human',
        '</content></td>',
    ...
    testBuildWithClasses() {
      ...
      const expected = [
        ...
        '<td class="tpe"><content id="StringAdapter-tpe-.*-container">',
        'juvenile, human',
        '</content></td>',
