...
/**
 * @file Widgets for user interactions.
 * @module widget
 * @version 51
...
window.NexusHoratio.widget = (function widget() {
   ...
   * handle these to validate any internal structures they need.  For example,
   * Widgets that have ARIA support can ensure appropriate attributes are in
   * place.  If a Widget fails, it should throw an Error with a detailed
   * cause.
   */
  class Widget {
  ...
  class Layout extends Widget {
    ...
    static #Panel = class {
      ...
      /**
       * @alias module:widget.Layout~Panel
  ...
  class Tab {
     ...
     * @returns {Tab} - This instance, for chaining.
     */
