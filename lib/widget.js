...
window.NexusHoratio.widget = (function widget() {
   ...
   *
   * A Grid consist of defined columns and data records.
   */
  class Grid extends Widget {
    ...
    /** @type {string} - Name of the field to use for identification. */
    get uid() {
      return this.#uidField;
    }

    /**
     * @param {string} field - Which record field to use for identification.
     * @returns {Grid} - This instance, for chaining.
     */
    setUid(field) {
      // TODO: magic to update existing data
      this.#uidField = field;
      return this;
    }
  ...
  class GridTestCase extends NH.xunit.TestCase {
    ...
    testDefaults() {
      ...
      this.assertEqual(w.uid, 'uid', 'uid field name');
    }
    ...
    testChangeUid() {
      ...
      // Assert
      this.assertEqual(w.uid, 'blah', 'uid field name');
    }
