...
window.NexusHoratio.xunit = (function xunit() {
  ...
  /**
   * @const {number} version - Bumped per release.
   * @static
   */
  const version = 63;
  ...
  class TypeTool {
    ...
    /**
     * @callback ReprFunc
     * @memberof module:xunit.TypeTool~
     * @param {object} item - Anything.
     * @returns {string} String version of item.
     */
  ...
  /**
   * See {@link base.runTests} for an example of how this might be used.
   *
  ...
  class TestExecution {
    ...
    /** @type {number} - Returned from Date.now(). */
    start = 0;
  ...
  class TestResult {
     ...
     * @memberof module:xunit~TestResult~
  ...
  class TestCase {
     ...
     * @class
     * @extends Error
     * @memberof module:xunit.TestCase~
     */
