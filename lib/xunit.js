...
window.NexusHoratio.xunit = (function xunit() {
   ...
   *
   * Assertion methods should always take a plain text string, typcally named
   * `msg`, as the last parameter.  This string should be added to the
   * assertion specific error message in case of a failure.
   *
   * JavaScript does not portably have access to things like line numbers and
   ...
   * differentiation.
   *
   * Generally, register the subclass with a test runner that will do them all
   * in turn.
   *
   * @example
