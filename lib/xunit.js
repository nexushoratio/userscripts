...
window.NexusHoratio.xunit = (function xunit() {
   ...
   * TODO(#344): WIP
   *
   * Allow working with arbitrary types.
   *
   ...
   * to extend support.
   *
   * The method {@link addReprFunc()} can allow users to register their own.
   *
   * Migrating equality testing out of {@link TestCase} is a future goal.
   *
  ...
  class TypeTool {
    ...
    /** Initialize the {@link TypeTool} instance. */
    constructor() {
   ...
   *
   * @type {object} - Default testing support.
   * @property {boolean} enabled - Whether tests should be executed.
   * @property {TestCase[]} testCases - Registered TestCases.
   */
  const testing = {
    enabled: false,
    testCases: [],
  ...
  class TestResult {
    ...
    /**
     * @type {object} - MethodResult.
     * @property {string} methodName - Name of the TestCase.testMethod.
     * @property {string?} error - Name of caught exception.
     * @property {string} message - Message from the test or framework.
     */

    /** @type {MethodResult[]} - Unexpected exceptions. */
    errors = [];

    /** @type {MethodResult[]} - Explicit test failures. */
    failures = [];

    /** @type {MethodResult[]} - Skipped tests. */
    skipped = [];

    /** @type {MethodResult[]} - Successes. */
    successes = [];

    /** @type {Map<string, TestExecution} - All test executions. */
    tests = new Map();

    /**
     * Record an unexpected exception from a execution.
     *
     * @param {string} methodName - Name of the TestCase.testMethod.
   ...
   * testing.testCases}.  Similarly, this class provides a static method to
   * register such classes.
   *
   * @example
