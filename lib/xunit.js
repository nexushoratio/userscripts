...
window.NexusHoratio.xunit = (function xunit() {
  ...
  class TestCase {
    ...
    /**
     * @implements {ReprFunc}
     * @param {*} map - Any object.
     * @returns {string} - String version of map.
     */
    reprMap = (map) => {
      const str = String(map);
      return str;
    }

    /**
     * @implements {ReprFunc}
     * @param {*} set - Any object.
     * @returns {string} - String version of set.
     */
    reprSet = (set) => {
      const str = String(set);
      return str;
    }
  ...
  class TestCaseTestCase extends TestCase {
    ...
    testReprObject() {
      this.assertEqual(this.repr({a: '1'}), '[object Object]', 'simple');
      this.assertEqual(
        this.repr({b: {c: 'd', e: 1}}),
        '[object Object]',
        'nested'
    ...
    testReprMap() {
      this.assertEqual(this.repr(new Map()), '[object Map]', 'empty');
      this.assertEqual(
        this.repr(new Map([])),
        '[object Map]',
        'empty init'
    ...
    testReprSet() {
      this.assertEqual(this.repr(new Set()), '[object Set]', 'empty');
      this.assertEqual(
        this.repr(new Set([])),
        '[object Set]',
        'empty init'
