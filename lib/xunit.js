...
window.NexusHoratio.xunit = (function xunit() {
  ...
  class GetTypeTestCase extends TestCase {
    ...
    testBuiltInFunctionLike() {
      ...
      this.assertEqual(getType(BigInt), 'Function', 'bare BigInt');
      this.assertEqual(getType(RegExp()), 'RegExp', 'RegExp()');
      this.assertEqual(getType(RegExp('wxyz')), 'RegExp', 'RegExp()');
      this.assertEqual(getType(new RegExp('xyz', 'u')), 'RegExp', 'RegExp()');
