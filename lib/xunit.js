...
window.NexusHoratio.xunit = (function xunit() {
  ...
  class TestCaseTestCase extends TestCase {
    ...
    testGetReprFunc() {
      this.assertEqual(this.getReprFunc(null), String);
      this.assertEqual(this.getReprFunc(undefined), String);
      this.assertEqual(this.getReprFunc(1), String);
      this.assertEqual(this.getReprFunc(''), String);
      this.assertEqual(this.getReprFunc([]), this.reprArray);
    }
    ...
    testChangingDefaultRepr() {
      ...
      // Assert
      this.assertEqual(this.getReprFunc(null), x);
      this.assertEqual(this.getReprFunc(undefined), x);
      this.assertEqual(this.getReprFunc(1), x);
      this.assertEqual(this.getReprFunc(''), x);
      this.assertEqual(this.getReprFunc([]), this.reprArray);
    }
    ...
    testAddReprFunc() {
      ...
      this.assertNotEqual(this.getReprFunc(c), reprC);

      // Act
      this.addReprFunc('C', reprC);

      // Assert
      this.assertEqual(this.getReprFunc(c), reprC);
      this.assertEqual(this.getReprFunc(null), String);
      this.assertEqual(this.getReprFunc(undefined), String);
      this.assertEqual(this.getReprFunc(1), String);
      this.assertEqual(this.getReprFunc(''), String);
    ...
    testReprPrimitives() {
      this.assertEqual(this.repr(1), '1');
      this.assertEqual(this.repr('ab'), 'ab');
      this.assertEqual(this.repr(null), 'null');
      this.assertEqual(this.repr(undefined), 'undefined');
      this.assertEqual(this.repr({a: '1'}), '[object Object]');
      this.assertEqual(this.repr(['b', 2]), 'b,2');
      this.assertEqual(this.repr(Symbol('qwerty')), 'Symbol(qwerty)');
    }
