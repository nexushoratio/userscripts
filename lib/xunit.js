...
window.NexusHoratio.xunit = (function xunit() {
  ...
  /** @const {number} module:xunit.version - Bumped per release. */
  const version = 63;
   ...
   * to extend support.
   *
   * The {@link module:xunit.TypeTool#addReprFunc addReprFunc} method can
   * allow users to register their own.
   *
   * Migrating equality testing out of {@link module:xunit.TestCase TestCase}
   * is a future goal.
   *
  ...
  class TypeTool {
    ...
    /**
     * @callback module:xunit.TypeTool~ReprFunc
     * @param {object} item - Anything.
     * @returns {string} String version of item.
     */
     ...
     * @returns {module:xunit.TypeTool~ReprFunc} Function for this item.
     */
    getReprFunc(item) {
     ...
     * @param {module:xunit.TypeTool~ReprFunc} func - Function for this type.
     */
    ...
    /**
     * @method
     * @implements {module:xunit.TypeTool~ReprFunc}
  ...
  /**
   * See {@link module:base~runTests} for an example of how this might be
   * used.
   *
   * @const {object} testing - Default testing support.
   * @property {boolean} enabled - Whether tests should be executed.
   * @property {module:xunit.TestCase[]} testCases - Registered TestCases.
   */
  const testing = {
    enabled: false,
    testCases: [],
  ...
  class TestResult {
    ...
    /**
     * @typedef {object} module:xunit~TestResult~MethodResult
     * @property {string} methodName - Name of the associated {@link
     * module:xunit.TestCase} method.
     ...
     *
     * @type {module:xunit~TestResult~MethodResult[]}
     */
    errors = [];
     ...
     * All test executions.
     *
     * @type {Map<string,module:xunit~TestExecution>}
     */
    tests = new Map();
   ...
   *
   * Many expected methods exist, such as {@link module:xunit.TestCase#setUp
   * setUp}, {@link module:xunit.TestCase.setUpClass setUpClass}, {@link
   * module:xunit.TestCase#addCleanup addCleanup}, {@link
   * module:xunit.TestCase.addClassCleanup addClassCleanup}, etc.  No
   * `tearDown` methods, however; use {@link module:xunit.TestCase#addCleanup
   * addCleanup}.
   *
   ...
   * message.
   *
   * While the {@link module:xunit.TestCase#assertEqual assertEqual} method
   * will handle many cases by looking up special functions comparing by type.
   * There may be times when what it can handle needs to be enhanced.  There
   * are currently two ways to make such enhancements.
   *
   * First, the method {@link module:xunit.TestCase#addEqualFunc addEqualFunc}
   * will allow the test method to register an additional function for
   * comparing two identical instances.
   *
   * Second, the property {@link module:xunit.TestCase#defaultEqual
   ...
   * defaults to {@link module:xunit.TestCase#equalEqEqEq equalEqEqEq} which
   * uses the strict equality (`===`) operator.  This can be explicitly set in
   * the test method.  The method {@link module:xunit.TestCase#equalValueOf
   * equalValueOf} will use the instance's `valueOf()` method to get
   * comparable values, and may be useful in such cases.
   *
   ...
   * module:xunit.TestCase#repr repr} to turn values into strings for these
   * error messages.
   *
   ...
   * {@link module:xunit.TestCase#run run} method.  Generally, a system, like
   * {@link module:xunit~TestRunner TestRunner} is used to register a number
   * of TestCases, discover the test methods, and invoke all of them in turn.
   *
   * The sibling library, lib/base, enhances {@link testing} with a
   * convenience function to run all TestCases present in {@link
   * module:xunit.testing.testCases}.  Similarly, this class provides a static
   * method to register such classes.
   *
   * @static
   * @example
  ...
  class TestCase {
     ...
     * @class
     * @extends Error
     * @alias module:xunit.TestCase~Error
     */
    ...
    /**
     * @class
     * @extends module:xunit.TestCase~Error
     * @alias module:xunit.TestCase~Fail
     */
     ...
     * @class
     * @extends module:xunit.TestCase~Error
     * @alias module:xunit.TestCase~Skip
     */
     ...
     *
     * @param {module:xunit~TestResult} [result] - Instance for accumulating
     * results.  Typically, a test runner will pass in one of these to gather
     * results across multiple tests.
     * @returns {module:xunit~TestResult} Accumulated results (one is created
     * if not passed in).
     */
    run(result) {
     ...
     * @throws {module:xunit.TestCase~Skip}
     */
    skip(msg = '') {
     ...
     * @throws {module:xunit.TestCase~Fail}
     */
    fail(msg = '') {
    ...
    /**
     * @deprecated Migrate to this.typeTool.repr().
     *
     * @param {object} item - Anything.
     * @returns {string} String version of item.
     */
    ...
    /**
     * @typedef {object} module:xunit.TestCase~EqualOutput
    ...
    /**
     * @callback module:xunit.TestCase~EqualFunc
     * @param {object} first - First argument.
     * @param {object} second - Second argument.
     * @returns {module:xunit.TestCase~EqualOutput} Results of testing
     * equality.
     */
     ...
     * @param {object} first - First argument.
     * @param {object} second - Second argument.
     * @returns {module:xunit.TestCase~EqualFunc} Function that should be used
     * to test equality.
     */
     ...
     * @param {module:xunit.TestCase~EqualFunc} func - Function to call to
     * compare that type.
     */
    ...
    /**
     * @method
     * @implements {module:xunit.TestCase~EqualFunc}
     * @param {object} first - First argument.
     * @param {object} second - Second argument.
     * @returns {module:xunit.TestCase~EqualOutput} Results of testing
     * equality.
...
\\{"code": 0\\} !== "cause"`;
  ...
  /** Assembles and drives execution of {@link module:xunit.TestCase}s. */
  class TestRunner {

    /**
     * @param {function(): module:xunit.TestCase} tests - TestCases to
     * execute.
     */
    constructor(tests) {
      const badKlasses = [];
     ...
     *
     * @returns {module:xunit~TestResult} Collected results.
     */
    runTests() {
      const result = new TestResult();
    ...
    /**
     * @param {function(): module:xunit.TestCase} klass - TestCase to process.
     */
    ...
    /**
     * @param {function(): module:xunit.TestCase} klass - TestCase to process.
     * @param {module:xunit~TestResult} result - Result to use if any errors.
     */
     ...
     * @param {module:xunit~TestResult} result - Result of the execution.
     */
   ...
   *
   * @function module:xunit.runTests
   * @returns {module:xunit~TestResult} Accumulated results of these tests.
   */
  function runTests() {
