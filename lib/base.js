...
window.NexusHoratio.base = (function base() {
  ...
  /** Minimal requested version of library was not loaded. */
  class MinVersionError extends Exception {}

  /** Event type was not registered. */
  class EventTypeError extends Exception {}
  ...
  function ensure(versions) {
    ...
    for (const ver of versions) {
      ...
      if (minVersion > lib.version) {
        msg = `At least version ${minVersion} of library "${libraryName}" ` +
          `required; version ${lib.version} present.`;
        throw new MinVersionError(msg);
      }
    ...
    #getHandlers = (eventType) => {
      ...
      if (!handlers) {
        ...
        throw new EventTypeError(
          `${eventType} is not one of: ${eventTypes}`
        );
      }
      return handlers;
    }
  ...
  class DefaultMap extends Map {
     ...
     * @deprecated @param {...*} args - Extra arguments passed to the factory
