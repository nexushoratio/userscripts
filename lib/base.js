  ...
  class TestCase {
    ...
    static run() {
      ...
      try {
        ...
        if (e instanceof TestCase.Skip) {
          // TODO: add skip stuff to result
        } else {
          // TODO: add failed stuff to result
        }
      } finally {
        this.doClassCleanups();
      }
      return result;
    }
    ...
    static doClassCleanups() {
      while (this.classCleanups.length) {
        ...
        // TODO: decide how resistant these should be to exceptions
        func(...rest);
      }
    }
