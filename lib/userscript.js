 ...
 * @namespace NexusHoratio.userscript
 */
window.NexusHoratio.userscript = (function userscript() {
   ...
   * @memberof NexusHoratio.userscript
   */
  const version = 19;
   ...
   * @deprecated Replace use of the `name` property with `id`.
   ...
   * this extracts `@license` information from the userscript header.
   *
   * @memberof NexusHoratio.userscript
   * @returns {NexusHoratio.userscript~LicenseData} Extracted information.
   * @throws {external:Error} If cannot be extracted.
   */
  ...
  function environmentData() {
    // Really old versions of ScriptCat use the wrong spelling.
    const gm = GM.info ?? GM.Info ?? {};
  ...
  /**
   * Automatically load/save {@link NexusHoratio:base.Logger Logger} configs
   ...
   * ```
   *
   * @see {NexusHoratio.userscript.getValue}
   * @see {NexusHoratio.userscript.setValue}
   * @memberof NexusHoratio.userscript~
   */
  class LoggerConfigSaver {
    ...
    /**
     * @method
     * @implements {NexusHoratio.base.Logger~ConfigMutationHandler}
   ...
   * ```
   *
   * @see {NexusHoratio.userscript~LoggerConfigSaver}
   * @memberof NexusHoratio.userscript
